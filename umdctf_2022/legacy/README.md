...
![hint.png](https://github.com/03npan/ctf-write-ups/blob/main/umdctf_2022/legacy/hint.png)
...
![error.png](https://github.com/03npan/ctf-write-ups/blob/main/umdctf_2022/legacy/error.png)

Voila! We see the input is being compared to a variable `secret`. Using `secret` as our input, we get the flag.

![flag.png](https://github.com/03npan/ctf-write-ups/blob/main/umdctf_2022/legacy/flag.png)
